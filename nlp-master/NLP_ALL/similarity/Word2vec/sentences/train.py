...
def getToipc(file_name,toipc_type="lsi",topics_num=5,topics_words=5):
    """
    生成主题模型
    :param file_name:
...
print (json.dumps(getToipc("train_corpus.txt",topics_num=1,toipc_type="lsi"),  ensure_ascii=False))